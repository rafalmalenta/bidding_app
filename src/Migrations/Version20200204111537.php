 ...
 */
final class Version20200204111537 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE attributes (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, name VARCHAR(255) NOT NULL, possible_value LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_319B9E7012469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE attributes DROP FOREIGN KEY FK_319B9E7012469DE2');
